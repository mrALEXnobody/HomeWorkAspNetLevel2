...
namespace WebStoreGusev.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Order,CategoryId,BrandId,ImageUrl,Price,Manufacturer,Size,Id,Name")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Order,CategoryId,BrandId,ImageUrl,Price,Manufacturer,Size,Id,Name")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
